...
def check_password():
    ...
    if "password_correct" not in st.session_state:
        st.title("🔐 Akses Terbatas SMKN 56")
        st.text_input("Masukkan Password Sistem Aset:", type="password", on_change=password_entered, key="password")
        return False
...
if check_password():
    ...
    # --- MODUL 2: SENSUS BARANG (FEEDBACK + EXCEL) ---
